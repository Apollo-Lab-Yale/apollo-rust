...
use apollo_robot_preprocessor::modules::urdf_module::{ApolloURDFJointType};
use apollo_linalg::V;
use apollo_spatial::lie::se3_implicit_quaternion::{ApolloLieAlgPackIse3qTrait, ISE3q};
use crate::urdf_module_nalgebra::{ApolloURDFAxisNalgebra, ApolloURDFModuleNalgebra};
...
impl RobotKinematics {
    ...
    #[inline]
    pub fn fk(state: &V, urdf_module: &ApolloURDFModuleNalgebra, chain_module: &ApolloChainModule, dof_module: &ApolloDOFModule) -> Vec<ISE3q> {
        ...
        let joint_idx_to_dofs_mapping = dof_module.joint_idx_to_dofs_mapping();
