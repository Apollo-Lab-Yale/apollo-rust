...
impl PreprocessorModule for ApolloEnvironmentConvexDecompositionMeshesModule {
    ...
    fn build_raw(s: &Self::SubDirectoryType, progress_bar: &mut ProgressBarWrapper) -> Result<Self, String> {
        ...
        let module = ApolloConvexDecompositionMeshesModule::build_from_plain_meshes_module(&ss, progress_bar).expect("error");
