...
fn main() {
    ...
    let mut app = App::new()
        ...
        .apollo_bevy_draw_frame(&ISE3q::new(I3::from_slices_euler_angles(&[0.45, -0.2, -0.45], &[0.,0.,0.])), 0.2)
        .apollo_bevy_draw_frame(&ISE3q::new(I3::from_slices_euler_angles(&[0.45, 0.2, -0.45], &[0.,0.,0.])), 0.2)
        .apollo_bevy_draw_frame(&ISE3q::new(I3::from_slices_euler_angles(&[-0.2, -0.2, -0.45], &[0.,0.,0.])), 0.2)
        .apollo_bevy_draw_frame(&ISE3q::new(I3::from_slices_euler_angles(&[-0.2, 0.2, -0.45], &[0.,0.,0.])), 0.2);
