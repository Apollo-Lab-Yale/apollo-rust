...
use crate::{create_generic_build_from_adjusted_robot2, create_generic_build_from_combined_robot2, create_generic_build_raw, RobotPreprocessorModule, RobotPreprocessorSingleRobotDirectory};
use crate::utils::progress_bar::ProgressBarWrapper;
use crate::utils::stl::load_stl_file;
use crate::utils::trimesh::ToTriMesh;
...
impl RobotPreprocessorModule for ApolloConvexHullMeshesModule {
    fn relative_file_path_str_from_robot_sub_dir_to_module_dir() -> String { "mesh_modules/convex_hull_meshes_module".to_string() }
