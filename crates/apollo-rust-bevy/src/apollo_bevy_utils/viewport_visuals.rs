...
impl ViewportVisualsActions {
    ...
    pub fn action_spawn_line_apollo_space(commands: &mut Commands,
                                          meshes: &mut ResMut<Assets<Mesh>>,
                                          materials: &mut ResMut<Assets<StandardMaterial>>,
                                          start_point: Vec3,
                                          end_point: Vec3,
    ...
    pub fn action_draw_robotics_grid(commands: &mut Commands,
        ...
        let normal_color = Color::srgba(0.6,0.6,0.6,1.);

        Self::action_spawn_line_apollo_space(commands, meshes, materials, Vec3::new(0., 0., 0.), Vec3::new(10., 0., 0.), Color::srgba(1., 0., 0., 1.), x_and_y_width, true);
        Self::action_spawn_line_apollo_space(commands, meshes, materials, Vec3::new(0., 0., 0.), Vec3::new(-10., 0., 0.), normal_color, normal_width, true);

        Self::action_spawn_line_apollo_space(commands, meshes, materials, Vec3::new(0., 0., 0.), Vec3::new(0., 10., 0.), Color::srgba(0., 1., 0., 1.), x_and_y_width, true);
        Self::action_spawn_line_apollo_space(commands, meshes, materials, Vec3::new(0., 0., 0.), Vec3::new(0., -10., 0.), normal_color.clone(), normal_width, true);

        for i in 0..10 {
            Self::action_spawn_line_apollo_space(commands, meshes, materials, Vec3::new(i as f32, -10.0, 0.), Vec3::new(i as f32, 10.0, 0.), normal_color.clone(), normal_width, true);
            Self::action_spawn_line_apollo_space(commands, meshes, materials, Vec3::new(-i as f32, -10.0, 0.), Vec3::new(-i as f32, 10.0, 0.), normal_color.clone(), normal_width, true);

            Self::action_spawn_line_apollo_space(commands, meshes, materials, Vec3::new(-10.0, i as f32, 0.), Vec3::new(10.0, i as f32, 0.), normal_color.clone(), normal_width, true);
            Self::action_spawn_line_apollo_space(commands, meshes, materials, Vec3::new(-10.0, -i as f32, 0.), Vec3::new(10.0, -i as f32, 0.), normal_color.clone(), normal_width, true);
        }
    }
}